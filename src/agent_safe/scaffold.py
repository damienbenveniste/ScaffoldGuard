...
from agent_safe.adapters import adapters_for
from agent_safe.fs import ensure_relative_safe_path, is_within_directory, write_text_safely
...
PACKAGE_TEMPLATE_SPECS = (
    ...
    TemplateSpec("package/agent-safe.toml.j2", "agent-safe.toml"),
